...
The function should add the last two elements of lst together and append the result to lst. It should do this process three times 
and then return lst.
...
def every_three_nums(start): 
  ...
  if start <= 100:
    lst = [start]
    length = len(lst)
    while length<4 and lst[-1]<100:
      lst.append(lst[length-1]+3)
      length = len(lst)
  return lst
